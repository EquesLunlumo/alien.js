...
import vertPerlin from './shaders/perlin.vert';
import fragPerlin from './shaders/perlin.frag';

Config.UI_COLOR = 'white';

Config.ASSETS = [
    'assets/js/lib/three.min.js',
    'assets/images/NGC_3324_1920px.jpg',
...
class TitleTexture extends Component {
    ...
    constructor() {
        ...
        this.update = () => {
            ...
            text = CanvasFont.createText(canvas, Stage.width, Stage.height, 'Perlin'.toUpperCase(), `200 ${fontSize}px Oswald`, Config.UI_COLOR, {
...
class Space extends Component {
    ...
    constructor() {
        ...
        function initTextures() {
            img1 = Assets.createImage('assets/images/HubblePAO_1920px.jpg');
            img2 = Assets.createImage('assets/images/NGC_3324_1920px.jpg');
