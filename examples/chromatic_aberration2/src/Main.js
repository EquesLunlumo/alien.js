...
class TitleTexture extends Component {
    ...
    constructor() {
        ...
        this.update = () => {
            ...
            text = CanvasFont.createText(canvas, Stage.width, Stage.height, 'Chromatic Aberration 2'.toUpperCase(), {
...
class World extends Component {
    ...
    constructor() {
        ...
        this.animateIn = () => {
            ...
            tween(shader.uniforms.uDistortion, { value: 100 }, 7000, 'easeOutSine');
        };
