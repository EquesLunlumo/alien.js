...
import vertColorize from './shaders/colorize.vert';
import fragColorize from './shaders/colorize.frag';
...
class TitleTexture extends Component {
    ...
    constructor() {
        ...
        this.update = () => {
            ...
            text = CanvasFont.createText(canvas, Stage.width, Stage.height, 'Colorize'.toUpperCase(), `200 ${Device.phone ? 28 : 66}px Oswald`, Config.UI_COLOR, {
...
class Space extends Component {
    ...
    constructor() {
        ...
        function initMesh() {
            ...
            shader = self.initClass(Shader, vertColorize, fragColorize, {
                time: World.time,
                resolution: World.resolution,
