...
window.tween = function (object, props, time, ease, delay, complete, update) {
    ...
    TweenMax$1.to(object, time * 0.001, props);
    return promise;
};
...
class Render {
    ...
    static init() {
        ...
        TweenMax$1.ticker.addEventListener('tick', tick);
        ...
        this.destroy = () => {
            TweenMax$1.ticker.removeEventListener('tick', tick);
        };
    }
}
...
class Interface {
    ...
    show() {
        TweenMax$1.set(this.element, { clearProps: 'display' });
        return this;
    }

    hide() {
        TweenMax$1.set(this.element, { display: 'none' });
        return this;
    }

    visible() {
        TweenMax$1.set(this.element, { visibility: 'visible' });
        return this;
    }

    invisible() {
        TweenMax$1.set(this.element, { visibility: 'hidden' });
        return this;
    }

    setZ(z) {
        TweenMax$1.set(this.element, { zIndex: z });
        return this;
    }

    mouseEnabled(bool) {
        TweenMax$1.set(this.element, { pointerEvents: bool ? 'auto' : 'none' });
        return this;
    }
    ...
    size(w, h = w, noScale) {
        ...
        if (typeof w !== 'undefined') {
            ...
            TweenMax$1.set(this.element, style);
        }
    ...
    blendMode(mode, bg) {
        TweenMax$1.set(this.element, { [bg ? 'background-blend-mode' : 'mix-blend-mode']: mode });
        return this;
    }
    ...
    css(props, value) {
        if (typeof props !== 'object') {
            if (typeof value === 'undefined') {
                ...
                TweenMax$1.set(this.element, { [props]: value });
                return this;
            }
        }
        ...
        TweenMax$1.set(this.element, props);
        return this;
    }
    ...
    transformPoint(x, y, z) {
        ...
        if (transformOrigin === '') TweenMax$1.set(this.element, { clearProps: 'transformOrigin' });
        else TweenMax$1.set(this.element, { transformOrigin });
        return this;
    }

    clearOpacity() {
        TweenMax$1.set(this.element, { clearProps: 'opacity' });
        return this;
    }
    ...
    clearTransform() {
        ...
        TweenMax$1.set(this.element, { clearProps: 'transform' });
        return this;
    }

    willChange(props) {
        if (!props) TweenMax$1.set(this.element, { clearProps: 'willChange' });
        else TweenMax$1.set(this.element, { willChange: typeof props === 'string' ? props : 'transform, opacity' });
        return this;
    }

    backfaceVisibility(visible) {
        TweenMax$1.set(this.element, { backfaceVisibility: visible ? 'visible' : 'hidden' });
        return this;
    }
    ...
    disable3D() {
        TweenMax$1.set(this.element, { clearProps: 'transformStyle, perspective, perspectiveOrigin' });
        return this;
    }
    ...
    click(callback) {
        ...
        TweenMax$1.set(this.element, { cursor: 'pointer' });
        return this;
    }
    ...
    removeOverflowScroll() {
        TweenMax$1.set(this.element, { clearProps: 'overflow, overflowX, overflowY, -webkit-overflow-scrolling' });
...
class ScrollWarp extends Component {
    ...
    constructor(object, container) {
        ...
        function setHeight() {
            ...
            TweenMax$1.set(self.inner, { height });
        }
        ...
        function loop() {
            ...
            TweenMax$1.set(self.object.element, { y: -self.last, skewY: delta / window.innerHeight * 10 });
        }
...
export { Interpolation, Utils, Render, Worker, Events, Device, Component, Interface, Interaction, Accelerometer, Mouse, Magnetic, Assets, AssetLoader, MultiLoader, FontLoader, Fullscreen, StateDispatcher, Storage, WebAudio, Canvas, CanvasGraphics, CanvasTexture, CanvasFont, Color, SVG, Video, BackgroundVideo, Scroll, ScrollLock, ScrollWarp, Slide, SlideLoader, SlideVideo, Webcam, WebcamMotion, LinkedList, ObjectPool, Vector2, Vector3, Utils3D, Interaction3D, Raycaster, ScreenProjection, Shader, ShaderStage, ShaderObject, ShaderInteraction2D, ShaderInteraction3D, Effects, ParticlePhysics, Particle, RandomEulerRotation, WiggleBehavior, EulerIntegrator, Stage, TweenMax$1 as TweenMax, TweenLite, TimelineLite, TimelineMax, CSSPlugin, AttrPlugin, BezierPlugin, DirectionalRotationPlugin, RoundPropsPlugin, TweenPlugin, Ease, Power0, Power1, Power2, Power3, Power4, Linear, Back, Elastic, Bounce, RoughEase, SlowMo, SteppedEase, Circ, Expo, Sine, ExpoScaleEase };
