...
(function (global, factory) {
    ...
    var MultiLoader = function (_Component3) {
        ...
        function MultiLoader() {
            ...
            var _this21 = _possibleConstructorReturn(this, (MultiLoader.__proto__ || Object.getPrototypeOf(MultiLoader)).call(this));
            ...
            _this21.push = function (loader) {
                loaders.push(loader);
                _this21.events.add(loader, Events.PROGRESS, progress);
                _this21.events.add(loader, Events.COMPLETE, complete);
            };

            _this21.complete = function () {
                _this21.events.fire(Events.PROGRESS, { percent: 1 }, true);
                _this21.events.fire(Events.COMPLETE, null, true);
            };
            return _this21;
        }
    ...
    var FontLoader = function (_Component4) {
        ...
        function FontLoader(fonts, callback) {
            ...
            var _this22 = _possibleConstructorReturn(this, (FontLoader.__proto__ || Object.getPrototypeOf(FontLoader)).call(this));
    ...
    var StateDispatcher = function (_Component5) {
        ...
        function StateDispatcher(forceHash) {
            ...
            _this23.getState = function () {
                var path = getPath();
                return { value: storeState, path: path };
            };

            _this23.setState = function (state, path) {
            ...
            _this23.replaceState = function (state, path) {
                if ((typeof state === 'undefined' ? 'undefined' : _typeof(state)) !== 'object') {
                    path = state;
                    state = null;
                }
            ...
            _this23.setTitle = function (title) {
                return document.title = title;
            };

            _this23.lock = function () {
                return _this23.locked = true;
            };

            _this23.unlock = function () {
                return _this23.locked = false;
            };

            _this23.forceHash = function () {
                return forceHash = true;
            };

            _this23.setPathRoot = function (path) {
    ...
    var CanvasGraphics = function (_CanvasObject) {
        ...
        function CanvasGraphics() {
            ...
            _this24.draw = function (override) {
                if (_this24.isMask() && !override) return false;
                var context = _this24.canvas.context;
                _this24.startDraw(_this24.px, _this24.py, override);
                setProperties(context);
                if (_this24.clipWidth && _this24.clipHeight) {
                    context.beginPath();
                    context.rect(_this24.clipX, _this24.clipY, _this24.clipWidth, _this24.clipHeight);
                    context.clip();
                }
            ...
            _this24.clear = function () {
                for (var i = draw.length - 1; i >= 0; i--) {
                    draw[i].length = 0;
                }draw.length = 0;
            };

            _this24.arc = function () {
                var x = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
                var y = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
                var radius = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : _this24.radius || _this24.width / 2;
            ...
            _this24.quadraticCurveTo = function (cpx, cpy, x, y) {
                draw.push(['quadraticCurveTo', cpx, cpy, x, y]);
            };

            _this24.bezierCurveTo = function (cp1x, cp1y, cp2x, cp2y, x, y) {
                draw.push(['bezierCurveTo', cp1x, cp1y, cp2x, cp2y, x, y]);
            };

            _this24.fillRect = function (x, y, w, h) {
                draw.push(['fillRect', x, y, w, h]);
            };

            _this24.clearRect = function (x, y, w, h) {
                draw.push(['clearRect', x, y, w, h]);
            };

            _this24.strokeRect = function (x, y, w, h) {
                draw.push(['strokeRect', x, y, w, h]);
            };

            _this24.moveTo = function (x, y) {
                draw.push(['moveTo', x, y]);
            };

            _this24.lineTo = function (x, y) {
                draw.push(['lineTo', x, y]);
            };

            _this24.stroke = function () {
                draw.push(['stroke']);
            };

            _this24.fill = function () {
                if (!mask) draw.push(['fill']);
            };

            _this24.beginPath = function () {
                draw.push(['beginPath']);
            };

            _this24.closePath = function () {
                draw.push(['closePath']);
            };

            _this24.fillText = function (text) {
            ...
            _this24.strokeText = function (text) {
                var x = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
                var y = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
            ...
            _this24.setLineDash = function (value) {
                draw.push(['setLineDash', value]);
            };

            _this24.drawImage = function (img) {
                ...
                draw.push(['drawImage', img, sx, sy, sWidth, sHeight, dx + -_this24.px, dy + -_this24.py, dWidth, dHeight]);
            };

            _this24.mask = function (object) {
                if (!object) return mask = null;
                mask = object;
                object.masked = _this24;
                for (var i = 0; i < draw.length; i++) {
            ...
            _this24.clone = function () {
                var object = new CanvasGraphics(_this24.width, _this24.height);
                object.visible = _this24.visible;
                object.blendMode = _this24.blendMode;
                object.opacity = _this24.opacity;
                object.follow(_this24);
                object.props = Utils.cloneObject(_this24.props);
                object.setDraw(Utils.cloneArray(draw));
                return object;
            };

            _this24.setDraw = function (array) {
                draw = array;
            };
            return _this24;
        }
    ...
    var Canvas = function Canvas(w) {
        ...
        this.toDataURL = function (type, quality) {
            return _this25.element.toDataURL(type, quality);
        };

        this.render = function (noClear) {
            if (!(typeof noClear === 'boolean' && noClear)) _this25.clear();
            for (var i = 0; i < _this25.children.length; i++) {
                _this25.children[i].render();
            }
        };

        this.clear = function () {
            _this25.context.clearRect(0, 0, _this25.element.width, _this25.element.height);
        };

        this.add = function (child) {
            child.setCanvas(_this25);
            child.parent = _this25;
            _this25.children.push(child);
            child.z = _this25.children.length;
        };

        this.remove = function (child) {
            child.canvas = null;
            child.parent = null;
            _this25.children.remove(child);
        };

        this.destroy = function () {
            if (_this25.children) for (var i = _this25.children.length - 1; i >= 0; i--) {
                _this25.children[i].destroy();
            }_this25.object.destroy();
            return Utils.nullObject(_this25);
        };

        this.getImageData = function () {
            var x = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
            var y = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
            var w = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : _this25.element.width;
            var h = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : _this25.element.height;

            _this25.imageData = _this25.context.getImageData(x, y, w, h);
            return _this25.imageData;
        };

        this.getPixel = function (x, y, dirty) {
            if (!_this25.imageData || dirty) _this25.getImageData();
            var imgData = {},
                index = (x + y * _this25.element.width) * 4,
                pixels = _this25.imageData.data;
        ...
        this.putImageData = function (imageData) {
            _this25.context.putImageData(imageData, 0, 0);
        };
    };
    ...
    var CanvasTexture = function (_CanvasObject2) {
        ...
        function CanvasTexture(texture) {
            ...
            _this26.draw = function (override) {
                if (_this26.isMask() && !override) return false;
                var context = _this26.canvas.context;
                if (_this26.texture) {
                    _this26.startDraw(_this26.px, _this26.py, override);
                    context.drawImage(_this26.texture, -_this26.px, -_this26.py, _this26.width, _this26.height);
                    _this26.endDraw();
                }
                if (mask) {
            ...
            _this26.mask = function (object) {
                if (!object) return mask = null;
                mask = object;
                object.masked = _this26;
            };
            return _this26;
        }
    ...
    var Color = function Color(value) {
        ...
        this.setHSL = function (h, s, l) {
            if (s === 0) {
                _this27.r = _this27.g = _this27.b = l;
            } else {
                var p = l <= 0.5 ? l * (1 + s) : l + s - l * s,
                    q = 2 * l - p;
                _this27.r = hue2rgb(q, p, h + 1 / 3);
                _this27.g = hue2rgb(q, p, h);
                _this27.b = hue2rgb(q, p, h - 1 / 3);
            }
            return _this27;
        };

        this.offsetHSL = function (h, s, l) {
            var hsl = _this27.getHSL();
            hsl.h += h;
            hsl.s += s;
            hsl.l += l;
            _this27.setHSL(hsl.h, hsl.s, hsl.l);
            return _this27;
        };

        this.getStyle = function (a) {
            if (a) return 'rgba(' + (_this27.r * 255 | 0) + ', ' + (_this27.g * 255 | 0) + ', ' + (_this27.b * 255 | 0) + ', ' + a + ')';else return 'rgb(' + (_this27.r * 255 | 0) + ', ' + (_this27.g * 255 | 0) + ', ' + (_this27.b * 255 | 0) + ')';
        };

        this.getHex = function () {
            return _this27.r * 255 << 16 ^ _this27.g * 255 << 8 ^ _this27.b * 255 << 0;
        };

        this.getHexString = function () {
            return '#' + ('000000' + _this27.getHex().toString(16)).slice(-6);
        };

        this.getHSL = function () {
            if (!_this27.hsl) _this27.hsl = { h: 0, s: 0, l: 0 };
            var hsl = _this27.hsl,
                r = _this27.r,
                g = _this27.g,
                b = _this27.b,
        ...
        this.mix = function (color, percent) {
            _this27.r *= 1 - percent + color.r * percent;
            _this27.g *= 1 - percent + color.g * percent;
            _this27.b *= 1 - percent + color.b * percent;
        };
        ...
        this.clone = function () {
            return new Color([_this27.r, _this27.g, _this27.b]);
        };

        this.toArray = function () {
            if (!_this27.array) _this27.array = [];
            _this27.array[0] = _this27.r;
            _this27.array[1] = _this27.g;
            _this27.array[2] = _this27.b;
            return _this27.array;
        };

        this.random = function () {
            var color = '#' + Math.floor(Math.random() * 16777215).toString(16);
            if (color.length < 7) color = _this27.random();
            return color;
        };
    };
    ...
    var Video = function (_Component6) {
        ...
        function Video(params) {
            ...
            _this28.play = function () {
                _this28.playing = true;
                _this28.element.play();
                _this28.startRender(step);
            };

            _this28.pause = function () {
                _this28.playing = false;
                _this28.element.pause();
                _this28.stopRender(step);
            };

            _this28.stop = function () {
                _this28.playing = false;
                _this28.element.pause();
                _this28.stopRender(step);
                if (_this28.ready()) _this28.element.currentTime = 0;
            };

            _this28.volume = function (v) {
                _this28.element.volume = v;
                if (_this28.muted) {
                    _this28.muted = false;
                    _this28.object.attr('muted', '');
                }
            };

            _this28.mute = function () {
                _this28.volume(0);
                _this28.muted = true;
                _this28.object.attr('muted', true);
            };

            _this28.seek = function (t) {
                if (_this28.element.readyState <= 1) {
                    _this28.delayedCall(function () {
                        if (_this28.seek) _this28.seek(t);
                    }, 32);
                    return;
                }
                _this28.element.currentTime = t;
            };

            _this28.canPlayTo = function (t) {
                seekTo = null;
                if (t) seekTo = t;
                if (!_this28.buffered) _this28.startRender(checkReady);
                return _this28.buffered;
            };

            _this28.ready = function () {
                return _this28.element.readyState > _this28.element.HAVE_CURRENT_DATA;
            };

            _this28.size = function (w, h) {
                _this28.element.width = _this28.width = w;
                _this28.element.height = _this28.height = h;
                _this28.object.size(_this28.width, _this28.height);
            };

            _this28.forceRender = function () {
                forceRender = true;
                _this28.startRender(step);
            };
            ...
            _this28.destroy = function () {
                ...
                return _get(Video.prototype.__proto__ || Object.getPrototypeOf(Video.prototype), 'destroy', _this28).call(_this28);
            };
            return _this28;
        }
    ...
    var Slide = function (_Component8) {
        ...
        function Slide() {
            ...
            _this31.goto = function (i) {
                var obj = {};
                obj.x = i * _this31.max.x;
                obj.y = i * _this31.max.y;
                TweenManager.tween(scrollTarget, obj, 2500, 'easeOutQuint');
            };

            _this31.next = function () {
                var progress = (_this31.x + _this31.y) / (_this31.max.x + _this31.max.y),
                    i = Math.round(progress);
                _this31.goto(i + 1);
            };

            _this31.prev = function () {
                var progress = (_this31.x + _this31.y) / (_this31.max.x + _this31.max.y),
                    i = Math.round(progress);
                _this31.goto(i - 1);
            };
    ...
    var SlideVideo = function (_Component9) {
        ...
        function SlideVideo(params, callback) {
            ...
            var _this32 = _possibleConstructorReturn(this, (SlideVideo.__proto__ || Object.getPrototypeOf(SlideVideo)).call(this));
            ...
            _this32.play = function () {
                _this32.element.play();
            };

            _this32.pause = function () {
                _this32.element.pause();
            };

            _this32.ready = function () {
                return _this32.element.readyState > _this32.element.HAVE_CURRENT_DATA;
            };
            ...
            _this32.destroy = function () {
                ...
                return _get(SlideVideo.prototype.__proto__ || Object.getPrototypeOf(SlideVideo.prototype), 'destroy', _this32).call(_this32);
            };
            return _this32;
        }
    ...
    var SlideLoader = function (_Component10) {
        ...
        function SlideLoader(slides, callback) {
            ...
            slides.forEach(function (params) {
                ...
                _this33.pathList.push(params.path);
            });
    ...
    var Webcam = function (_Component11) {
        _inherits(Webcam, _Component11);

        function Webcam(width, height, audio) {
            _classCallCheck(this, Webcam);

            var _this34 = _possibleConstructorReturn(this, (Webcam.__proto__ || Object.getPrototypeOf(Webcam)).call(this));
            ...
            _this34.createStream = function (config) {
                attempts = 0;
                _this34.config = config;
                establishWebcam();
            };

            _this34.flip = function () {
                if (!back) return;
                var direction = void 0;
                if (_this34.facing === 'front') {
                    _this34.facing = 'back';
                    direction = cameras.back;
                } else {
                    _this34.facing = 'front';
                    direction = cameras.front;
                }
                _this34.stream.getTracks()[0].stop();
                navigator.getUserMedia({
            ...
            _this34.size = function (w, h) {
                _this34.element.width = _this34.width = w;
                _this34.element.height = _this34.height = h;
                _this34.object.size(_this34.width, _this34.height);
            };

            _this34.getPixels = function () {
                var w = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _this34.width;
                var h = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _this34.height;

                if (!_this34.canvas) _this34.canvas = _this34.initClass(Canvas, w, h);
                _this34.canvas.context.drawImage(_this34.element, 0, 0, w, h);
                return _this34.canvas.context.getImageData(0, 0, w, h);
            };

            _this34.ready = function () {
                return _this34.element.readyState > 0;
            };

            _this34.end = function () {
                _this34.active = false;
                _this34.element.pause();
                if (_this34.stream) _this34.stream.getTracks()[0].enabled = false;
            };

            _this34.restart = function () {
                _this34.element.play();
                if (_this34.stream) _this34.stream.getTracks()[0].enabled = true;
                _this34.active = true;
            };

            _this34.destroy = function () {
                _this34.element.src = '';
                _this34.object.destroy();
                return _get(Webcam.prototype.__proto__ || Object.getPrototypeOf(Webcam.prototype), 'destroy', _this34).call(_this34);
            };
            return _this34;
        }
    ...
    var WebcamMotion = function (_Component12) {
        _inherits(WebcamMotion, _Component12);

        function WebcamMotion(webcam) {
            var width = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 64;
            var height = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 48;
            var threshold = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 80;
            var length = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 50;
            var fps = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : 24;

            _classCallCheck(this, WebcamMotion);

            var _this35 = _possibleConstructorReturn(this, (WebcamMotion.__proto__ || Object.getPrototypeOf(WebcamMotion)).call(this));

            var self = _this35;
            _this35.capturing = false;
            var gesture = {
                xDir: null,
                xValue: 0,
                yDir: null,
                ...
                event = {},
                outputAverage = {};
            var oldPixels = void 0,
                outputMotion = void 0;

            _this35.startRender(loop, fps);
            ...
            function process() {
                var pixels = webcam.getPixels(width, height).data;
            ...
            function track() {
                ...
                outputMotion.forEach(function (p) {
                    p[0] = 1 - p[0] / width;
                    p[1] /= height;
                });
                ...
                event.gesture = null;
                self.events.fire(Events.UPDATE, event, true);
                var diffX = lastAverage.x - average.x,
                ...
                var diffY = lastAverage.y - average.y,
    ...
    var LinkedList = function LinkedList() {
        ...
        this.push = function (object) {
            var obj = add(object);
            if (!_this36.first) {
                obj.next = obj.prev = _this36.last = _this36.first = obj;
            } else {
                obj.next = _this36.first;
                obj.prev = _this36.last;
                _this36.last.next = obj;
                _this36.last = obj;
            }
        };
        ...
        this.remove = function (object) {
            ...
            if (nodes.length <= 1) {
                ...
                if (obj === _this36.first) {
                    _this36.first = obj.next;
                    _this36.last.next = _this36.first;
                    _this36.first.prev = _this36.last;
                } else if (obj == _this36.last) {
                    _this36.last = obj.prev;
                    _this36.last.next = _this36.first;
                    _this36.first.prev = _this36.last;
                } else {
    ...
    var ObjectPool = function ObjectPool(type, number) {
        ...
        this.destroy = function () {
            ...
            }return Utils.nullObject(_this37);
        };
    };
            ...
            value: function getCubemap(src) {
                ...
                if (!this.textures[path]) {
                    ...
                    for (var i = 0; i < 6; i++) {
                        ...
                        images.push(img);
                        img.onload = function () {
                            return _this38.textures[path].needsUpdate = true;
                        };
                    }
    ...
    var Raycaster = function (_Component13) {
        _inherits(Raycaster, _Component13);
        ...
        function Raycaster(camera) {
            ...
            _this39.pointsThreshold = function (value) {
                raycaster.params.Points.threshold = value;
            };

            _this39.debug = function (scene) {
            ...
            _this39.checkFromValues = function (objects, origin, direction) {
    ...
    var Interaction3D = function (_Component14) {
        _inherits(Interaction3D, _Component14);
        ...
        function Interaction3D(camera) {
            ...
            _this40.add = function (meshes, hoverCallback, clickCallback, parse) {
                if (!Array.isArray(meshes) || parse) meshes = parseMeshes(meshes);
                meshes.forEach(function (mesh) {
                    _this40.meshes.push(mesh);
                    _this40.meshCallbacks.push({ hoverCallback: hoverCallback, clickCallback: clickCallback });
                });
            };

            _this40.remove = function (meshes, parse) {
                if (!Array.isArray(meshes) || parse) meshes = parseMeshes(meshes);
                meshes.forEach(function (mesh) {
                    if (mesh === hoverTarget) {
                        triggerHover('out', hoverTarget);
                        hoverTarget = null;
                        Stage.css('cursor', _this40.cursor);
                    }
                    for (var i = _this40.meshes.length - 1; i >= 0; i--) {
                        if (_this40.meshes[i] === mesh) {
                            _this40.meshes.splice(i, 1);
                            _this40.meshCallbacks.splice(i, 1);
                        }
                    }
                });
            };
    ...
    var ScreenProjection = function (_Component15) {
        _inherits(ScreenProjection, _Component15);

        function ScreenProjection(camera) {
            _classCallCheck(this, ScreenProjection);

            var _this41 = _possibleConstructorReturn(this, (ScreenProjection.__proto__ || Object.getPrototypeOf(ScreenProjection)).call(this));

            var v3 = new THREE.Vector3(),
                v32 = new THREE.Vector3(),
                value = new THREE.Vector3();

            _this41.set = function (v) {
                camera = v;
            };

            _this41.unproject = function (mouse, distance) {
                var rect = _this41.rect || Stage;
    ...
    var Shader = function (_Component16) {
        _inherits(Shader, _Component16);
    ...
    var Effects = function (_Component17) {
        _inherits(Effects, _Component17);
        ...
        function Effects(stage, params) {
            ...
            _this43.destroy = function () {
                ...
                camera = null;
                scene = null;
                return _get(Effects.prototype.__proto__ || Object.getPrototypeOf(Effects.prototype), 'destroy', _this43).call(_this43);
            };
            return _this43;
        }
    ...
    exports.WebcamMotion = WebcamMotion;
    ...
    exports.ParticlePhysics = ParticlePhysics;
    exports.Particle = Particle;
    exports.RandomEulerRotation = RandomEulerRotation;
